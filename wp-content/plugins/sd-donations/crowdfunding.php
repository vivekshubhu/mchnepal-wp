<?php
/**
 * Plugin Name: Crowdfunding for Easy Digital Downloads
 * Plugin URI:  http://skat.tf
 * Description: A crowdfunding platform in the likes of Kickstarter and Indigogo. Originally developed by Astoundify; now maintained by Skat Design for customers using HelpingHands WordPress Theme.
 * Author:      Skat Design
