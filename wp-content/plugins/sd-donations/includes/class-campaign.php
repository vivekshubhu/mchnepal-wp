	...
	public function current_amount( $formatted = true ) {
		...
		if ( ! isset( $this->current_amount ) ) {
			...
			foreach( $campaign_ids as $campaign_id ) {
				$this->current_amount += (int)get_post_meta( $campaign_id, '_edd_download_earnings', true );
				$this->current_amount += (int)get_post_meta( $campaign_id, '_edd_download_preapproved_earnings', true );
			}
		}
