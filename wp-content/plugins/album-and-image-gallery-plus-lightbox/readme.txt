...
* **lazyload :** [aigpl-gallery-slider lazyload="ondemand"] (Add lazy load to the images. By defaults there is no lazyload. Two options can be passed. 'ondemand', 'progressive')
