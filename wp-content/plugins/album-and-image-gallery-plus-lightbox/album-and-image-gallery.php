...
if( !defined( 'AIGPL_VERSION' ) ) {
	define( 'AIGPL_VERSION', '1.3.2' ); // Version of plugin
}
...
if( !defined( 'AIGPL_PLUGIN_LINK' ) ) {
    define( 'AIGPL_PLUGIN_LINK', 'https://www.wponlinesupport.com/wp-plugin/album-image-gallery-plus-lightbox/?utm_source=WP&utm_medium=Album-Gallery&utm_campaign=Features-PRO' ); // Plugin link
}
