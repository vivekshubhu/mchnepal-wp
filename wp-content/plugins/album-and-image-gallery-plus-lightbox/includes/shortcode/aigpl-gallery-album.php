...
function aigpl_gallery_album( $atts, $content = null ) {
	...
	if ( empty($_GET['album']) && $aigpl_query->have_posts() ) { ?>
		...
		<div class="aigpl-gallery-album-wrp aigpl-gallery-album aigpl-clearfix aigpl-album-<?php echo $album_design; ?> <?php echo $extra_class; ?>" id="aigpl-gallery-<?php echo $unique; ?>">
