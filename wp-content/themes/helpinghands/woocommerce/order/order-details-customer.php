...
<section class="woocommerce-customer-details">
	...
	<h3 class="sd-widget-title"><?php _e( 'Customer details', 'woocommerce' ); ?></h3>

	<table class="woocommerce-table woocommerce-table--customer-details shop_table customer_details sd-customer-details">
