<?php
			...
			Redux::setSection( $opt_name, array(
				...
				'fields'    => array(
					...
					array(
						...
						'text-align'  => false,
						'font-weight' => true,
						'compiler'    => array( '.sd-page-top h2', '.sd-page-top h1' ),
					),
				),
			) );
			...
			Redux::setSection( $opt_name, array(
					...
					'fields'    => array(
						array(
							'id'        => 'sd_enable_church',
							'type'      => 'switch',
							'title'     => __( 'Enable Church Options', 'sd-framework' ),
							'subtitle'  => __( 'Refresh the page after save.', 'sd-framework' ),
							'on'        => __( 'Enabled', 'sd-framework' ),
							'off'       => __( 'Disabled', 'sd-framework' ),
							'default'   => false,
						),
						array(
							'id'       => 'sd_sermons_per_page',
							'type'     => 'text',
							'title'    => __( 'Sermons Per Page', 'sd-framework' ),
							'subtitle' => __( 'Insert the number of sermons to be displayed on the sermons page before pagination', 'sd-framework' ),
							'default'  => '3',
							'required' => array( 'sd_enable_church', "=", 1 ),
						),
						array(
							'id'        => 'sd_sermons_post_meta_enable',
							'type'      => 'switch',
							'title'     => __('Sermons Post Meta', 'sd-framework'),
							'subtitle'  => __('Enable or disable the sermons post meta.', 'sd-framework'),
							'default'   => true,
							'on'        => __('Enabled', 'sd-framework'),
							'off'       => __('Disabled', 'sd-framework'),
							'required' => array( 'sd_enable_church', "=", 1 ),
						...
						array(
							'id'       => 'sd_sermons_post_meta',
							'type'     => 'checkbox',
							'title'    => __( 'Sermons Post Meta Options', 'sd-framework' ),
							'subtitle' => __( 'Select what info do you want to display for the sermons meta.', 'sd-framework' ),
							'desc' => __( 'This info appears right under the title.', 'sd-framework' ),
							'options'  => array(
								'1' => __( 'Topics', 'sd-framework' ),
								'2' => __( 'Books', 'sd-framework' ),
								'3' => __( 'Series', 'sd-framework' ),
								'4' => __( 'Speakers', 'sd-framework' )
							),
							'default'  => array(
								'1' => '1',
								'2' => '1',
							...
							'required'  => array('sd_sermons_post_meta_enable', "=", 1)
						),
						array(
							'id'        => 'search_sermons_results',
							'type'      => 'select',
							'data'      => 'pages',
							'title'     => esc_html__( 'Sermons Search Results Page', 'travelpress' ),
							'subtitle'  => esc_html__( 'Sealect the sermons search results page.', 'travelpress' ),
						),
						array(
							'id'       => 'sd_sermons_slug',
							'type'     => 'text',
							'title'    => __( 'Sermons Slug', 'sd-framework' ),
							'subtitle' => __( 'Insert the sermons slug (eg. sermons-page)', 'sd-framework' ),
							'default'  => '',
							'hint'     => array(
								'title'   => __( 'Flush Permalinks', 'sd-framework' ),
								'content' => __( 'After changing the slug make sure you flush your permalink settings. WP dashboard > Settings > Permalinks and click "Save changes"', 'sd-framework' ),
						...
						array(
							'id'       => 'sd_topics_slug',
							'type'     => 'text',
							'title'    => __( 'Sermon Topics Slug', 'sd-framework' ),
							'subtitle' => __( 'Insert the sermon topic slug (eg. sermons-topics)', 'sd-framework' ),
							'default'  => '',
							'hint'     => array(
								'title'   => __( 'Flush Permalinks', 'sd-framework' ),
								'content' => __( 'After changing the slug make sure you flush your permalink settings. WP dashboard > Settings > Permalinks and click "Save changes"', 'sd-framework' ),
						...
						array(
							'id'       => 'sd_books_slug',
							'type'     => 'text',
							'title'    => __( 'Sermon Books Slug', 'sd-framework' ),
							'subtitle' => __( 'Insert the sermon books slug (eg. sermons-books)', 'sd-framework' ),
							'default'  => '',
							'hint'     => array(
								'title'   => __( 'Flush Permalinks', 'sd-framework' ),
								'content' => __( 'After changing the slug make sure you flush your permalink settings. WP dashboard > Settings > Permalinks and click "Save changes"', 'sd-framework' ),
						...
						array(
							'id'       => 'sd_series_slug',
							'type'     => 'text',
							'title'    => __( 'Sermon Series Slug', 'sd-framework' ),
							'subtitle' => __( 'Insert the sermon series slug (eg. sermons-series)', 'sd-framework' ),
							'default'  => '',
							'hint'     => array(
								'title'   => __( 'Flush Permalinks', 'sd-framework' ),
								'content' => __( 'After changing the slug make sure you flush your permalink settings. WP dashboard > Settings > Permalinks and click "Save changes"', 'sd-framework' ),
						...
						array(
							'id'       => 'sd_speakers_slug',
							'type'     => 'text',
							'title'    => __( 'Sermon Speakers Slug', 'sd-framework' ),
							'subtitle' => __( 'Insert the sermon speakers slug (eg. sermons-speakers)', 'sd-framework' ),
							'default'  => '',
							'hint'     => array(
								'title'   => __( 'Flush Permalinks', 'sd-framework' ),
								'content' => __( 'After changing the slug make sure you flush your permalink settings. WP dashboard > Settings > Permalinks and click "Save changes"', 'sd-framework' ),
     ...
     */
	 ...
	 function compiler_action($options, $css) {
		...
		function sd_redux_styles() {
			wp_register_style( 'sd-redux-styles', get_template_directory_uri() . '/framework/admin/sd-admin-options/sd-redux-styles.css', array( 'redux-css' ), '', 'all' );
			wp_enqueue_style( 'sd-redux-styles' );
		}
		
		add_action('admin_enqueue_scripts', 'sd_redux_styles' ) ;
	...
	add_action( 'admin_enqueue_scripts', 'sd_redux_admin_css' );
