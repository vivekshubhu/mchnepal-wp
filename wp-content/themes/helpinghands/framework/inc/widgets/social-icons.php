...
// The widget class
class HH_sd_social_icons_widget extends WP_Widget {
	
	// Widget Settings
	function __construct() {
		parent::__construct(
			'sd_social_icons_widget', // Base ID
			esc_html__( 'Social Icons', 'sd-framework' ), // Name
			array( 'description' => esc_html__( 'A widget that displays icons from your social profiles.', 'sd-framework' ), ) // Args
		);
	}
...
function sd_social_icons_widget() {
	register_widget( 'HH_sd_social_icons_widget' );
}
