...
// The widget class
class HH_sd_upcoming_events_widget extends WP_Widget {
	
	// Widget Settings
	function __construct() {
		parent::__construct(
			'sd_upcoming_events_widget', // Base ID
			esc_html__( 'Upcoming Events', 'sd-framework' ), // Name
			array( 'description' => esc_html__( 'A widget to display the upcoming events.', 'sd-framework' ), ) // Args
		);
	}
...
function sd_upcoming_events_widget() {
	register_widget( 'HH_sd_upcoming_events_widget' );
}
