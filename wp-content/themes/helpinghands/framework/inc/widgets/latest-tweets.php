...
// The widget class
class HH_sd_tweets_widget extends WP_Widget {
	
	// Widget Settings
	function __construct() {
		parent::__construct(
			'sd_tweets_widget', // Base ID
			esc_html__( 'Latest Tweets', 'sd-framework' ), // Name
			array( 'description' => esc_html__( 'A widget that displays your latest tweets.', 'sd-framework' ), ) // Args
		);
	}
...
function sd_tweets_widget() {
	register_widget( 'HH_sd_tweets_widget' );
}
