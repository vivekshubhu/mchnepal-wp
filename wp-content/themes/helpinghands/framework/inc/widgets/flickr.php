...
// The widget class
class HH_sd_flickr_widget extends WP_Widget {
	
	// Widget Settings
	function __construct() {
		parent::__construct(
			'sd_flickr_widget', // Base ID
			esc_html__( 'Flickr Photos', 'sd-framework' ), // Name
			array( 'description' => esc_html__( 'A widget to display your flickr photos.', 'sd-framework' ), ) // Args
		);
	}
...
function sd_flickr_widget() {
	register_widget( 'HH_sd_flickr_widget' );
}
