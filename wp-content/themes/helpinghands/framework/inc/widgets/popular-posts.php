...
// The widget class
class HH_sd_popular_posts_widget extends WP_Widget {
	
	// Widget Settings
	function __construct() {
		parent::__construct(
			'sd_popular_posts_widget', // Base ID
			esc_html__( 'Popular Posts', 'sd-framework' ), // Name
			array( 'description' => esc_html__( 'A widget to display the popular posts.', 'sd-framework' ), ) // Args
		);
	}
...
function sd_popular_posts_widget() {
	register_widget( 'HH_sd_popular_posts_widget' );
}
