...
if ( !function_exists( 'sd_css_styles' ) ) {
	function sd_css_styles() {
		...
		if ( is_multisite() ) {
			wp_register_style( 'sd-custom-css-' . get_current_blog_id() , get_template_directory_uri() . '/framework/admin/sd-admin-options/custom-styles-' . get_current_blog_id() . '.css', get_template_directory_uri() . '/framework/admin/sd-admin-options/custom-' . get_current_blog_id() . '.css', 'style' );
		} else {
			wp_register_style( 'sd-custom-css', get_template_directory_uri() . '/framework/admin/sd-admin-options/custom-styles.css', get_template_directory_uri() . '/framework/admin/sd-admin-options/custom.css', 'style');
		}
